    ...
    <div id="about" className="relative flex bg-white dark:bg-black flex-col gap-5 items-center justify-center p-10">
      ...
      <div className="w-full text-black mb-4 dark:text-white text-center lg:w-2/3">
        <div className="flex flex-col items-start w-full gap-4 text-start">
          <p className='leading-relaxed text-lg dark:text-gray-100 text-gray-600 '>Hello! I'm Lokesh Naga Sai Darla based in Amaravati, India 🇮🇳. I'm an undergraduate student studying CSE at SRM University AP 🎓 and a Software Engineer Full Stack Developer Intern in Webknot Technologies 🧑🏻‍💻.</p>
      ...
      <div className='lg:w-2/3'>
        ...
        <ol className="relative border-s border-gray-200 dark:border-gray-700 ">
          <li className="mb-5 ms-4">
            ...
            <time className="mb-1 text-sm font-normal leading-none text-gray-800 dark:text-gray-200">August 2024 - Present</time>
            <div className="mr-6 mt-4 h-12 w-40 relative">
              <Image
                draggable={false}
                src={`/images/webknot.svg`}
            ...
            <p className=" text-base font-normal text-gray-500 dark:text-gray-400">Working with React, Postgres, Python , Flask , Express and Mongodb.Contibutes to cross functional teams.</p>
          </li>
          ...
          <li className="mb-10 ms-4">
            <div className="absolute w-3 h-3 bg-gray-200 rounded-full mt-1.5 -start-1.5 border border-white dark:border-gray-900 dark:bg-gray-700"></div>
            <time className="mb-1 text-sm font-normal leading-none text-gray-800 dark:text-gray-200">April 2024 - July 2024</time>
            <div className="mr-6 mt-4 h-12 w-40 relative">
              <Image
                draggable={false}
            ...
            <p className="mb-4 text-base font-normal text-gray-500 dark:text-gray-400">Worked  in various teams including Java, AI, and MERN stack teams. Contributed to the <Link className='text-blue-600 underline' href={'https://platui.com/'}>PlatUI</Link> project, converting Figma designs into code.</p>
          </li>
